...
const rootURL = 'https://cooperspencer.github.io/gickup-documentation/';
...
function loadActions() {
  ...
  headingNodes.forEach(function(node){
    link = createEl('a');
    icon = createEl('img');
    icon.src = 'https://cooperspencer.github.io/gickup-documentation/icons/link.svg';
  ...
  function copyFeedback(parent) {
    ...
    if(!elem(`.${yanked}`, parent)) {
      ...
      icon.src = 'https://cooperspencer.github.io/gickup-documentation/icons/check.svg';
